  ...
  <main>
    <div class="text-center">
      <form class="form-signin" action="reset.php" method="POST">
        ...
        <input name="password" type="password" id="inputPassword" class="form-control" placeholder="Password" autofocus required>
        <label for="conf_inputPassword" class="sr-only">Confirm Password</label>
        <input name="conf_password" type="password" id="conf_inputPassword" class="form-control" placeholder="Password" required>
