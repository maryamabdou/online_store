...
<body>
    ...
    <div class="container" style="display: flex; flex-direction: row; justify-content: center; align-items: center;">
        <button class="btn btn-md btn-outline-primary" onclick="location='add_product_page.php'"
            style="margin-right: 15px;">Add Product</button>
        <button class="btn btn-md btn-outline-primary" onclick="location='taken_orders.php'"
            style="margin-right: 15px;">View
            Orders</button>
        <button class="btn btn-md btn-outline-primary" onclick="location='display_added.php'"
